...
public class CsHistoryController implements Initializable{
    ...
    private void handleSearchButton(ActionEvent event) {
        ...
        Student student = studentFacade.getStudentByNumber(studentName);
        ...
        if(student != null){
            ...
            showAlert(Alert.AlertType.WARNING, "Warning", "Student Name Not Found", "Student with ID " + searchField.getText() + " does not exist.");
